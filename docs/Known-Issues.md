...
Further note: If you attempt to clone any release previous to v27 and run `./update` from inside the directory, it will fail. This means that you can't develop against previous releases; you must do your work off of `develop`.
